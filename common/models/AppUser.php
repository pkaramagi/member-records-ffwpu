    ...
    */
	...
	public function upload($filename)
    {
        if ($this->validate()) {
            ...
            $this->imageFile->saveAs($imagePath.'/' . $filename);
            return true;
        } else {
            return false;
        }
